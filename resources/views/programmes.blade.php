            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6 mt-4">
                    <div class="p-4 border rounded shadow-sm">
                        ...
                        <p class="text-responsive">Offrir ces opportunités à des jeunes issus de milieux diversifiés.</p>
                        <p class="text-responsive">Favoriser l'accès à des réseaux professionnels et à des mentores.</p>
                    </div>
                </div>
            </div>
